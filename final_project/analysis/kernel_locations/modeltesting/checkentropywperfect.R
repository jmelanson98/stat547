###### Fixing entropy issues with perfect data
### February 19, 2026
### J. Melanson
...
dataset = read.csv("analysis/kernel_locations/modeltesting/entropy/perfectdata.csv")
...
write.csv(draws, paste0("analysis/kernel_locations/modeltesting/entropy/perfect/",
                        params$key[task_id],
...
draws = read.csv(paste0("analysis/kernel_locations/entropy/perfect/", 
                        params$key[task_id], 
                        "_Rmax", params$Rmax[task_id], 
                        "_deltaprior", params$deltaprior[task_id],
                        "_draws.csv"))
...
write.csv(profile, paste0("analysis/kernel_locations/modeltesting/entropy/perfect/", 
                          params$key[task_id], 
                          "_Rmax", params$Rmax[task_id], 
                          "_deltaprior", params$deltaprior[task_id],
                          "_profile.csv"))
...
saveRDS(col2, paste0("analysis/kernel_locations/modeltesting/entropy/perfect/", 
                     params$key[task_id], 
                     "_Rmax", params$Rmax[task_id], 
                     "_deltaprior", params$deltaprior[task_id],
                     "_grob.rds"))
...
for (i in 1:11){
  task_id = i
  profile = read.csv(paste0("analysis/kernel_locations/modeltesting/entropy/perfect/", 
                          params$key[task_id], 
                          "_Rmax", params$Rmax[task_id], 
                          "_deltaprior", params$deltaprior[task_id],
                          "_profile.csv"))
  draws = read.csv(paste0("analysis/kernel_locations/modeltesting/entropy/perfect/", 
                          params$key[task_id], 
                          "_Rmax", params$Rmax[task_id], 
                          "_deltaprior", params$deltaprior[task_id],
                          "_draws.csv"))
...
ggsave("analysis/kernel_locations/modeltesting/report_figures/perfectentropyfix.png",
       final_plot,
       width = 2800,
       height = 1200,,
       units = "px",
